...
function getConnection() {
	...
	global $db_usuarios_db_Url, $db_usuarios_db_User, $db_usuarios_db_Pass, $db_usuarios_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_usuarios_db_Url.";dbname=".$db_usuarios_db_DbName, $db_usuarios_db_User, $db_usuarios_db_Pass);
